...
<Step title="Ajouter une autorisation d'API à l'app registry `JaskSSO`">

Rendez vous sur le [portail Microsoft Entra](https://entra.microsoft.com/#view/Microsoft_AAD_RegisteredApps/ApplicationsListBlade/quickStartType~/null/sourceType/Microsoft_AAD_IAM) de l'app registry JaskSSO [(Suivre le guide ici pour créer JaskSSO)](/docs/datasources/providers/microsoft/).
...
![scopes](/images/sharepoint/scopes.png)
...
![granted](/images/sharepoint/granted.png)

</Step>

<Step title="Créer une app registry `JaskAdmin`">
...
![Microsoft Entra](/images/microsoft/Microsoft-New-App.png)
...
![Microsoft Entra App ID](/images/microsoft/Microsoft-App-ID.png)
...
![Microsoft Entra Secret](/images/microsoft/Microsoft-New-Secret.png)

Récupérez la `Valeur` du secret pour la suite.

![Microsoft Entra Secret](/images/microsoft/Microsoft-Secret-Value.png)
...
![Jask Secret Management](/images/microsoft/Jask-Secret-Management.png)
...
![source de données](/images/sharepoint/add.png)
...
![source de données](/images/sharepoint/info.png)
...
![connectivité](/images/sharepoint/access.png)
...
![connectivité](/images/sharepoint/type.png)

Cliquez sur le bouton `Revoir et Créer` pour valider la configuration.

![connectivité](/images/sharepoint/next.png)

</Step>

<Step title="Indexer la source manuellement">
...
![connectivité](/images/sharepoint/index.png)
...
<Columns cols={2}>
  <Card title="Créer un agent" href="/docs/catalog/agents/create" />
  <Card
    title="Créer une application"
    href="/docs/catalog/agents/applications/create"
  />
  <Card title="Recherche IA de document" href="/docs/workspace/datasources" />
</Columns>
